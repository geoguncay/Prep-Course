...
function invocarMetodo(objeto, metodo) {
	// "método" es una cadena que contiene el nombre de un método (función) en el objeto
	// Invoca ese método
...
function eliminarPropiedad(objeto, unaPropiedad) {
	// Elimina la propiedad de objeto cuyo nombre está pasado por el parámetro unaPropiedad
...
console.log(eliminarPropiedad(objec, "z"));
...
console.log(tienePropiedad(obj, "y"));
...
console.log(agregarAmigo(user, "Shay").amigos.pop());
...
console.log(sumarLikesDeUsuario(use));
