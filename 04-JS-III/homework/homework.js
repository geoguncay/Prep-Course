...
console.log(arrayContiene([97, 100, 80, 55, 72, 94], 'Hola'));
console.log(arrayContiene([], true));


function agregarNumeros(numeros) {
	// "números" debe ser un arreglo de enteros (int/integers)
...
function numeroMasGrande(numeros) {
	// "números" debe ser una matriz de enteros (int/integers)
...
function multiplicarArgumentos() {
	...
	return arguments.length === 0 ? 0 : arguments.length === 0 ? arguments[1] : [...arguments].reduce((a, b) => a * b);
}
